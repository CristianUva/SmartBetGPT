...
# IMPORTANTE: Configurazione corretta per l'account specificato
username = 'cristianuva'  # Username corretto di PythonAnywhere
...
if is_pythonanywhere:
    # Configurazione per PythonAnywhere con le informazioni specifiche dell'account
    db_config = {
        'user': 'cristianuva',
        'password': 'Angelogalanti69',  
        'host': 'cristianuva.mysql.pythonanywhere-services.com',
        'database': 'cristianuva$smartbetgpt', 
